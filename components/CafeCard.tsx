    ...
    >
      <div className="relative">
        ...
        <button 
          ...
          className="absolute top-3 left-3 p-2 bg-black/40 backdrop-blur-sm rounded-full text-white hover:bg-black/60 hover:text-accent-pink transition-all duration-200"
      ...
      <div className="p-4">
        ...
        <div className="flex flex-wrap gap-2">
          {cafe.vibes.slice(0, 2).map(vibe => (
            <span key={vibe.id} className="bg-gray-100 text-gray-600 dark:bg-gray-700/50 dark:text-gray-300 px-3 py-1 rounded-full text-xs font-semibold">
              {vibe.name}
            </span>
          ))}
        </div>
