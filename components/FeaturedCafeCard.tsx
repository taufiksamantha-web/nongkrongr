...
const FeaturedCafeCard: React.FC<FeaturedCafeCardProps> = ({ cafe }) => {
  ...
  return (
    <div className="relative h-full bg-card/80 dark:bg-card/70 backdrop-blur-md rounded-3xl border-2 border-amber-400/60 shadow-lg shadow-amber-400/20 hover:shadow-xl hover:shadow-amber-400/30 transition-all duration-500 overflow-hidden group transform hover:scale-[1.01] hover:-translate-y-1 flex flex-col">
      ...
      <Link to={`/cafe/${cafe.slug}`} className="flex flex-col h-full">
          ...
          <div className="p-5 sm:p-6 flex flex-col flex-grow">
            <div>
              ...
              <p className="text-sm sm:text-base text-muted mb-4 sm:mb-6 line-clamp-3 leading-relaxed">
                "{displayQuote}"
              </p>
            </div>
            
            <div className="mt-auto">
              <div className="flex items-center space-x-4 sm:space-x-6 mb-4 border-t border-border/50 pt-4">
                <div className="flex items-center space-x-2">
                  <StarIcon className="h-5 w-5 sm:h-6 sm:w-6 text-accent-pink" />
                  <div>
                    <p className="text-[10px] text-muted font-bold uppercase">Aesthetic</p>
                 ...
                 <div className="flex items-center space-x-2">
                  ...
                  <div>
                    <p className="text-[10px] text-muted font-bold uppercase">Nugas</p>
                    <p className="text-lg font-bold">{cafe.avgWorkScore.toFixed(1)}</p>
                  </div>
                </div>
              </div>
              
              <div className="inline-flex items-center text-brand font-bold group-hover:underline text-base transition-all">
                Lihat Detail
