...
const FeaturedCafeCard: React.FC<FeaturedCafeCardProps> = ({ cafe }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto bg-card rounded-4xl shadow-xl hover:shadow-2xl dark:hover:shadow-brand/20 transition-all duration-500 overflow-hidden group transform hover:scale-[1.01] hover:-translate-y-1 animate-fade-in-up border border-border">
      <Link to={`/cafe/${cafe.slug}`} className="block">
        <div className="grid md:grid-cols-5">
          ...
          <div className="md:col-span-3 p-8">
            ...
            <h3 className="text-4xl font-extrabold font-jakarta text-primary dark:text-white mb-3">{cafe.name}</h3>
            ...
            <div className="flex items-center space-x-6 mb-8">
              <div className="flex items-center space-x-2">
               ...
               <div className="flex items-center space-x-2">
                <BriefcaseIcon className="h-8 w-8 text-accent-cyan" />
                <div>
